...
const Config = {
	...
	StartPosition: {lat: 48.13681, lon: 11.57417, pitch: 45, yaw: 0, distance: 2000},
	...
	TileServerEndpoint: 'https://osm.strubbl.de/bayern-tiles',
	SlippyEndpointTemplate: 'https://tile.openstreetmap.org/{z}/{x}/{y}.png',
	ElevationEndpointTemplate: 'https://osm-tiles.ams3.cdn.digitaloceanspaces.com/elevation/{z}/{x}/{y}.png',
	TilesEndpointTemplate: 'https://osm.strubbl.de/bayern-tiles/data/data/{z}/{x}/{y}.pbf'
};
